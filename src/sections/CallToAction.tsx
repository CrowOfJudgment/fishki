        ...
        <div className="container">
          <div className="section-heading relative">
            ...
            <motion.img
                ...
                alt="Chef Left"
                width={360}
                className="absolute -left-[10rem] -top-[8rem] sm:-left-[10rem] sm:-top-[7rem] md:-left-[350px] md:-top-[137px]"
                style={{
                  translateY,
                }}
            />
            <motion.img
                ...
                alt="Chef Right"
                width={360}
                className="absolute -right-[10rem] top-[2rem] sm:-right-[10rem] sm:-top-[8rem] md:-right-[331px] md:-top-[19px]"
                style={{
                  translateY,
                }}
            />
          ...
          <div className="flex gap-2 mt-10 justify-center">
            <button className="btn btn-primary" onClick={() => router.push('/signup')}>
              {intl.formatMessage({ id: "cta.getNow" })}
            </button>
