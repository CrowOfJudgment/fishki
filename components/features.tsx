      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="mx-auto max-w-3xl pb-16 text-center md:pb-20">
            <h3 className="text-lg font-bold text-gray-200 md:text-4xl">
              {t.features.heading}
            </h3>
          </div>
          ...
          <div className="grid overflow-hidden sm:grid-cols-2 lg:grid-cols-3 *:relative *:p-6 *:before:absolute *:before:bg-gray-800 *:before:[block-size:100vh] *:before:[inline-size:1px] *:before:[inset-block-start:0] *:before:[inset-inline-start:-1px] *:after:absolute *:after:bg-gray-800 *:after:[block-size:1px] *:after:[inline-size:100vw] *:after:[inset-block-start:-1px] *:after:[inset-inline-start:0] md:*:p-10">
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>{t.features.value.heading}</span>
              </h3>
              <p className="text-[15px] text-gray-400">
                {t.features.value.text}
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>{t.features.problem.heading}</span>
              </h3>
              <p className="text-[15px] text-gray-400">
                {t.features.problem.text}
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>{t.features.how.heading}</span>
              </h3>
              <p className="text-[15px] text-gray-400">
                {t.features.how.text}
              </p>
            ...
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>{t.features.simulation.heading}</span>
              </h3>
              <p className="text-[15px] text-gray-400">
                {t.features.simulation.text}
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>{t.features.why.heading}</span>
              </h3>
              <p className="text-[15px] text-gray-400">
                {t.features.why.text}
              </p>
            ...
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>{t.features.built.heading}</span>
              </h3>
              <p className="text-[15px] text-gray-400">
                {t.features.built.text}
              </p>
            </article>
          </div>
        </div>
